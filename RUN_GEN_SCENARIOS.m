classdef RUN_GEN_SCENARIOS
    % to generate wind power scenarios using the Long Term Generation
    % method, run:
    % >> RUN_GEN_SCENARIOS.LTG();
    %
    % to generate wind power scenarios using the Naive Concatenation
    % Method, run:
    % >> RUN_GEN_SCENARIOS.NCM()
